...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-01 22:33:25 UTC<br>状态：成功</p>
</section>
...
<p>速读：《A high-order polynomial-corrected shifted boundary method for simulating fully nonlinear water waves》（7.0/10）, 《Spectral-Embedded Operator Learning for Three-Phase Interfacial Flow: A Ternary Cahn-Hilliard-Navier-Stokes Benchmark》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A high-order polynomial-corrected shifted boundary method for simulating fully nonlinear water waves">A high-order polynomial-corrected shifted boundary method for simulating fully nonlinear water waves</span></li><li><span class="dpr-home-dashboard-paper-title" title="Spectral-Embedded Operator Learning for Three-Phase Interfacial Flow: A Ternary Cahn-Hilliard-Navier-Stokes Benchmark">Spectral-Embedded Operator Learning for Three-Phase Interfacial Flow: A Ternary Cahn-Hilliard-Navier-Stokes Benchmark</span></li></ul>
  </div>
