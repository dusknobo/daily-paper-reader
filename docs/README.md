...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-15 20:38:37 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Turbulence anisotropy in a bubbly vertical channel flow with topological change》（8.0/10）</p>
<p>速读：《K41 Scaling in Bubble-Induced Turbulence Arises from Single-Bubble Wakes》（7.0/10）, 《Eikonal Regularisation in Physics-Informed Neural Networks for Three-Dimensional Level-Set Advection: Transferability of Two-Dimensional Design Principles》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Turbulence anisotropy in a bubbly vertical channel flow with topological change">Turbulence anisotropy in a bubbly vertical channel flow with topological change</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="K41 Scaling in Bubble-Induced Turbulence Arises from Single-Bubble Wakes">K41 Scaling in Bubble-Induced Turbulence Arises from Single-Bubble Wakes</span></li><li><span class="dpr-home-dashboard-paper-title" title="Eikonal Regularisation in Physics-Informed Neural Networks for Three-Dimensional Level-Set Advection: Transferability of Two-Dimensional Design Principles">Eikonal Regularisation in Physics-Informed Neural Networks for Three-Dimensional Level-Set Advection: Transferability of Two-Dimensional Design Principles</span></li></ul>
  </div>
