...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-04 22:02:48 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Ventilated Cavitation around a sphere through surface air injection at Re = 10,000》（8.0/10）</p>
<p>速读：《A meshfree solver for coupled bulk-surface problems with self-organizing surface geometry》（7.0/10）, 《Interface-resolved simulations of boiling heat transfer》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Ventilated Cavitation around a sphere through surface air injection at Re = 10,000">Ventilated Cavitation around a sphere through surface air injection at Re = 10,000</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A meshfree solver for coupled bulk-surface problems with self-organizing surface geometry">A meshfree solver for coupled bulk-surface problems with self-organizing surface geometry</span></li><li><span class="dpr-home-dashboard-paper-title" title="Interface-resolved simulations of boiling heat transfer">Interface-resolved simulations of boiling heat transfer</span></li></ul>
  </div>
