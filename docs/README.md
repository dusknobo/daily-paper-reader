...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:24:11 UTC<br>状态：成功</p>
</section>
...
<p>速读：《An improved phase-field framework for simulating impacts of solidifying metal drops》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="An improved phase-field framework for simulating impacts of solidifying metal drops">An improved phase-field framework for simulating impacts of solidifying metal drops</span></li></ul>
  </div>
