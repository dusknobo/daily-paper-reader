...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-07 22:58:40 UTC<br>状态：成功</p>
</section>
...
<p>今日速读一篇数值计算论文，聚焦抛物界面问题中的非线性跳跃条件处理方法。</p>
<p>最值得关注的方向是浸入界面法在非线性跳跃条件下的扩展与应用。</p>
<p>若对该方向感兴趣，建议进一步精读全文并核对其适用条件与数值表现。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="An Immersed Interface Method for Parabolic Interface Problems with Nonlinear Jump Conditions">An Immersed Interface Method for Parabolic Interface Problems with Nonlinear Jump Conditions</span></li></ul>
  </div>
