...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-31 23:41:23 UTC<br>状态：成功</p>
</section>
...
<p>今日速读了一篇提出“大势相场-格子玻尔兹曼”新模型、用于带对流多相凝固模拟的论文。</p>
<p>最值得关注的是它尝试把相场与格子玻尔兹曼耦合，同时刻画多相凝固与对流输运。</p>
<p>下一步建议普通读者留意该模型在真实合金凝固场景中的验证，或对比传统方法看是否更高效稳定。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A novel Grand-Potential Phase-Field Lattice-Boltzmann model for multi-phase solidification with convection">A novel Grand-Potential Phase-Field Lattice-Boltzmann model for multi-phase solidification with convection</span></li></ul>
  </div>
