...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-18 19:34:50 UTC<br>状态：成功</p>
</section>
...
<p>精读：《A diffuse-interface method for compressible two-phase flows with seven- and six-equation models》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A diffuse-interface method for compressible two-phase flows with seven- and six-equation models">A diffuse-interface method for compressible two-phase flows with seven- and six-equation models</span></li></ul>
  </div>
